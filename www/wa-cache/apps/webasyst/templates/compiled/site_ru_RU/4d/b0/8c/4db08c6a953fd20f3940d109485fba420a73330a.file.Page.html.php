<?php /* Smarty version Smarty-3.1.14, created on 2017-09-29 16:25:13
         compiled from "Z:\home\shopscript.ru\www\wa-system\page\templates\Page.html" */ ?>
<?php /*%%SmartyHeaderCode:1835959ce2d99cdd204-71992425%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4db08c6a953fd20f3940d109485fba420a73330a' => 
    array (
      0 => 'Z:\\home\\shopscript.ru\\www\\wa-system\\page\\templates\\Page.html',
      1 => 1505828911,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1835959ce2d99cdd204-71992425',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59ce2d9a52bd00_08175853',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59ce2d9a52bd00_08175853')) {function content_59ce2d9a52bd00_08175853($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'Z:\\home\\shopscript.ru\\www\\wa-system\\vendors\\smarty3\\plugins\\modifier.truncate.php';
...
",
        ...
        if (!$.Redactor) {
            to_load.push("<?php echo $_smarty_tpl->tpl_vars['wa_url']->value;?>
...
");
            load_locale = <?php echo json_encode($_smarty_tpl->tpl_vars['lang']->value!='en');?>
;
        }
        ...
        return $.wa.loadFiles(to_load).then(function() {
            if (load_locale) {
                ...
                return $.wa.loadFiles("<?php echo $_smarty_tpl->tpl_vars['wa_url']->value;?>
...
?>
        ...
        <h4 class="heading">
            ...
            <i class="icon16 darr"></i> <?php if ($_smarty_tpl->tpl_vars['r']->value){?><?php echo smarty_modifier_truncate(htmlspecialchars(str_replace('www.','',$_smarty_tpl->tpl_vars['r']->value), ENT_QUOTES, 'UTF-8', true),23,'...',false,true);?>
