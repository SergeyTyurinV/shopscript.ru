<?php /* Smarty version Smarty-3.1.14, created on 2017-09-29 16:30:16
         compiled from "Z:\home\shopscript.ru\www\wa-apps\shop\templates\actions\csv\CsvProductsetup.import.html" */ ?>
<?php /*%%SmartyHeaderCode:950759ce2ec89883c4-41984848%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e86d73af35c4de00f1189d75fb6566d377d57484' => 
    array (
      0 => 'Z:\\home\\shopscript.ru\\www\\wa-apps\\shop\\templates\\actions\\csv\\CsvProductsetup.import.html',
      1 => 1452519801,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '950759ce2ec89883c4-41984848',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59ce2ec8ce3d10_19951784',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59ce2ec8ce3d10_19951784')) {function content_59ce2ec8ce3d10_19951784($_smarty_tpl) {?><h1>Импорт товаров из CSV-файла</h1>
<p>
    ...
    <div class="field">
        ...
        <div class="value no-shift">
            ...
            <select name="primary" class="bold">
                ...
                <option value="null" class="italic">(нет)</option>
            </select>
            &nbsp;
    ...
    <div class="field">
        ...
        <div class="value">
            <ul class="menu-h hint s-csv-header" id="s_import_csv_header">
                {% for (var column in file.header){if(file.header.hasOwnProperty(column)){ %}
                <li data-column="{%=column%}" title="{%=$.importexport.csv_product_helper.id2name(column)%}">{%=file.header[column]%}</li>
                {% }} %}
            </ul>
        </div>
    </div>
